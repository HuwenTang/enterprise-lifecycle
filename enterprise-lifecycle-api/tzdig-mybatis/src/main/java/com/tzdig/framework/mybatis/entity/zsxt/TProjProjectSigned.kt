...
@Table("t_proj_project_signed", comment = "")
open class TProjProjectSigned() : BaseModel<TProjProjectSigned>() {
    constructor(init: TProjProjectSigned.() -> Unit) : this() {
        this.init()
    }
    ...
    @Column(
        "investor_place",
        comment = "90-香港 ,100-台湾,110-日本,&#13;&#10;120-韩国,130-美国,140-欧洲,&#13;&#10;150-新加坡,80-外资其他&#13;&#10;10 北京&#13;&#10;20 上海&#13;&#10;30 广州&#13;&#10;40 深圳&#13;&#10;50 苏州&#13;&#10;60 长三角其他城市&#13;&#10;70 内资其他&#13;&#10;"
    )
    var investorPlace: String? = null

    @Column("place_info", comment = "投资方地址")
     ...
     * 项目简介, 大文本框
     */
    @Column("desc", comment = "项目简介, 大文本框")
    var desc: String? = null

    /**
     * 项目简介, 大文本框
     */
    @Column("_status", comment = "项目简介, 大文本框")
    ...
    var isFixedAsset: Int? = null

    /**
     * 是否涉及建设用地
     */
    @Column("is_use_land", comment = "是否涉及建设用地")
    var isUseLand: Int? = null
    ...
    var isGazelle: Int? = null

    /**
     * 是否为专精特新企业
     */
    @Column("is_specialized", comment = "是否为专精特新企业")
    var isSpecialized: Int? = null
     ...
     * 是否项目支持
     */
    @Column("sj_proj_is", comment = "是否项目支持")
    var sjProjIs: String? = null
     ...
     * 是否建立企业研发中心
     */
    @Column("build_yfzx_is", comment = "是否建立企业研发中心")
    var buildYfzxIs: String? = null
     ...
     * 开工招引单位
     */
    @Column("kg_zydw", comment = "开工招引单位")
    var kgZydw: String? = null

    /**
     * 开工项目名称
     */
    @Column("kg_xmmc", comment = "开工项目名称")
    var kgXmmc: String? = null

    /**
     * 开工投资方名称
     */
    @Column("kg_tzfmc", comment = "开工投资方名称")
    var kgTzfmc: String? = null

    /**
     * 开工项目地址
     */
    @Column("kg_xmdz", comment = "开工项目地址")
    var kgXmdz: String? = null

    /**
     * 开工签约日期
     */
    @Column("kg_qyrq", comment = "开工签约日期")
    var kgQyrq: LocalDate? = null

    /**
     * 开工项目类型
     */
    @Column("kg_xmlx", comment = "开工项目类型")
    var kgXmlx: String? = null

    /**
     * 开工科创项目
     */
    @Column("kg_kcxm", comment = "开工科创项目")
    var kgKcxm: String? = null

    /**
     * 开工QFLP
     */
    @Column("kg_qflp", comment = "开工QFLP")
    var kgQflp: String? = null

    /**
     * 开工统一信用代码
     */
    @Column("kg_tyxydm", comment = "开工统一信用代码")
    var kgTyxydm: String? = null

    /**
     * 开工注册日期
     */
    @Column("kg_zcrq", comment = "开工注册日期")
    var kgZcrq: LocalDate? = null

    /**
     * 开工主要建设内容
     */
    @Column("kg_jsnr", comment = "开工主要建设内容")
    var kgJsnr: String? = null

    /**
     * 开工行业代码
     */
    @Column("kg_hydm", comment = "开工行业代码")
    var kgHydm: String? = null

    /**
     * 开工行业名称
     */
    @Column("kg_hymc", comment = "开工行业名称")
    var kgHymc: String? = null

    /**
     * 开工产业方向
     */
    @Column("kg_cyfx", comment = "开工产业方向")
    var kgCyfx: String? = null

    /**
     * 开工总投资
     */
    @Column("kg_ztz", comment = "开工总投资")
    var kgZtz: String? = null

    /**
     * 开工固定资产投资
     */
    @Column("kg_gdzctz", comment = "开工固定资产投资")
    var kgGdzctz: String? = null

    /**
     * 开工科创项目认定条件
     */
    @Column("kg_kcxm_rdtj", comment = "开工科创项目认定条件")
    var kgKcxmRdtj: String? = null
     ...
     * 是否为签约工业、服务业项目转科创项目
     */
    @Column("jg_is_zkc", comment = "是否为签约工业、服务业项目转科创项目")
    var jgIsZkc: String? = null

    /**
     * 企业总人数
     */
    @Column("qy_total_num", comment = "企业总人数")
    var qyTotalNum: String? = null

    /**
     * 缴纳社保2个月以上人数
     */
    @Column("qy_sb_num", comment = "缴纳社保2个月以上人数")
    ...
    @Transient
    var files: List<TFile>? = null

    @Transient
    var fzList: List<String>? = null

    @Transient
    var fzLists: List<ProjectSignedFz>? = null
