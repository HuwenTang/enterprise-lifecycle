...
@Table("t_proj_project_signed_view")
class TProjProjectSignedView() : MapperModel<TProjProjectSignedView> {
    constructor(init: TProjProjectSignedView.() -> Unit) : this() {
        this.init()
    }
    ...
    var kgZtz: Double? = null

    /**
     * 开工固定资产投资
     */
    @Column("kg_gdzctz", comment = "开工固定资产投资")
    var kgGdzctz: Double? = null
