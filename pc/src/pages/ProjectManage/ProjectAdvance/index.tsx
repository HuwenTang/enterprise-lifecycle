...
const ProjectAdvance: FC = () => {
  ...
  const [data1, setData1] = useState<ProjectDigitalInvestmentAttractingVo1>();
                  ...
                  >
                    ...
                    >
                      ...
                      <Descriptions.Item
                        labelStyle={{ width: '25%' }}
                        label={
                          data1?.investmentFlagLabel === "内资" ? '项目总投资（亿元）' : '项目总投资（亿美元）'
                        }
                      >
                        {data1?.investmentFlagLabel === '内资'
                      ...
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="初次对接时间">
                        {data1?.firstTime ? dayjs(data1?.firstTime).format('YYYY-MM-DD') : ''}
                      </Descriptions.Item>
                ...
                <GridContent>
                  ...
                  >
                    ...
                    >
                        ...
                        <Descriptions.Item labelStyle={{ width: '25%' }} label="协议利用外资（亿美元）">
                          {data1?.agreementForeignDirectInvestment}
                        </Descriptions.Item>
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="是否有市外资金投入">
                        {data1?.ifOutCity === true ? '是' : data1?.ifOutCity === false ? '否' : '-'}
                      </Descriptions.Item>
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="股权比例">
                        {data1?.shareRatio || '-'}
                      </Descriptions.Item>
                      ...
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="产业大类名称">
                        ...
                        {/*<Descriptions.Item labelStyle={{ width: '25%' }} label="国民经济分类">*/}
                        {/*  {data1?.nationalEconomicClassification}*/}
                        {/*</Descriptions.Item>*/}
                      ...
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="投资方注册地">
                        {data1?.investorPlace || '-'}
                          ...
                          <Descriptions.Item labelStyle={{ width: '25%' }} label="城市名称">
                          {data1?.cityName || '-'}
                        </Descriptions.Item>

                        <Descriptions.Item labelStyle={{ width: '25%' }} label="是否属于上市企业">
                          {data1?.isPubliclyTradedOrPreIPOCompanyLabel}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item labelStyle={{ width: '25%' }} label="是否有融资需求">
                          {data1?.isRzxq}
                        </Descriptions.Item>
                        {data1?.isRzxq === '是' && (
                          <Descriptions.Item labelStyle={{ width: '25%' }} label="融资金额">
                            {data1?.rzMoney}
                          </Descriptions.Item>
                        )}
                        <Descriptions.Item labelStyle={{ width: '25%' }} label="是否科创项目">
                          {data1?.isKcProj}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item
                          labelStyle={{ width: '25%' }}
                          label={data1?.investmentFlagLabel === "内资" ? "注册资本（万元）" : "注册资本（万美元）"}
                        >
                          {data1?.registeredCapital}
                        </Descriptions.Item>

                        <Descriptions.Item labelStyle={{ width: '25%' }} label="签约日期">
                          {data1?.actualSigningTime ? dayjs(data1?.actualSigningTime).format('YYYY-MM-DD') : ''}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item labelStyle={{ width: '25%' }} label="是否增资扩产">
                          {data1?.isZzkc === true ? '是' : data1?.isZzkc === false ? '否' : '-'}
                        </Descriptions.Item>
                      ...
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="已供面积（亩）">
                        {data1?.suppliedArea}
                      </Descriptions.Item>
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="盘活面积（亩）">
                        {data1?.panHuoArea}
                      </Descriptions.Item>
                      ...
                      <Descriptions.Item labelStyle={{ width: '25%' }} label="预计签约当年年度投资额（万元）">
                        {data1?.tzgm}
                      </Descriptions.Item>
