...
export default function TotalIndustryValue1(){
    ...
    const fetchData =(page,pageSize)=>{
            console.log('innovativeCluster',innovativeCluster)
            fetch(`/prime-api/gdp/${year}?page=${page}&size=${pageSize}&innovativeCluster=${innovativeCluster}&futureIndustry=${futureIndustry}`).then(res=>res.json())
                .then(data=>{
                    console.log(data)
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Table onChange={handleTableChange} dataSource={items25} columns={year==='2025'?columns1:columns} pagination={false}
                           components={{
                               header: {
