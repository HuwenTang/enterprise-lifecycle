...
export default function InvestProject3() {
    ...
    const getData = async () => {
        const data =  await primeApi.listProjectCompletedInfo ({
            ...
            <List style={{
                ...
                {list.map((item, index) => (
                    <div key={index} style={{
                        ...
                        navigate(`/project-detail3?id=${item.id}`)
                    }}>
                        <div style={{
                            fontWeight: 'bold',
                            overflow: 'hidden',
                        ...
                        <div style={{
                            ...
                            style={{color: '#8587fa'}}>{item.unifiedCreditCode}</span>
                        </div>
