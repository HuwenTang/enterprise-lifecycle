  ...
  return (
    ...
    >
      ...
      <div style={{ background: "#fff", padding: "0.12rem 0.2rem 0.1rem" }}>
        <div className="list-page-subtitle">开工认定</div>
        ...
        {finished && list.length === 0 ? (
          ...
          return (
            <div
              ...
              onClick={() => {
                navigate(`/pro-start/pro-start-detail?id=${item.id}&isCom=0&zsid=${encodeURIComponent(zsid)}`);
              }}
            >
              <div
                style={{
              ...
              {item.startDate ? (
                ...
                >
                  开工日期：<span style={{ color: "#8587fa" }}>{item.startDate}</span>
                </div>
              ) : null}
