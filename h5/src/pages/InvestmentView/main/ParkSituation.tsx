...
function Table1(e:{year:string}) {
    const {year} = e
    const getZtxmZjNzViews = async ()=>{
        const data = await primeApi.getZtxmZjNzViews({year:+year})
        setData(data)
    }
...
function Table2(e:{year:string}) {
    ...
    const {year} = e
    const getZtxmZjWzViews = async ()=>{
        const data = await primeApi.getZtxmZjWzViews({year:+year})
        setData(data)
    }
    const [data, setData] = useState<InvestOnlineBo[]>()
    useEffect(() => {
...
function Table3(e:{year:string}) {
    const {year} = e
    const getZtxmZjTotalViews = async ()=>{
        const data = await primeApi.getZtxmZjTotalViews({year:+year})
        setData(data)
    }
    const [data, setData] = useState<InvestOnlineBo[]>()
    const waizi = [
...
export default function ParkSituation(e:{year:string}) {
    const {year} = e
