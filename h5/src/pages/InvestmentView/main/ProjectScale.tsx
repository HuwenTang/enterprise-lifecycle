...
export default function ProjectScale(e:{year:string}) {
    const {year} = e
    ...
    const getZtxmGmTjxxViewsExcel = async () => {
        // const data = await primeApi.getZtxmGmTjxxViewsExcel({year:parseInt(year)})
        const data = await primeApi.getZtxmGmTjxxAreaViews({year:parseInt(year)})
